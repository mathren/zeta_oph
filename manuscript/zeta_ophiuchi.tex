...
\begin{abstract}
  Most massive stars appear to be born in binary systems close enough
  ...
  evolution code \texttt{MESA} to self-consistently model the coupled
  evolution of two massive stars ($M_1\gtrsim 20\,M_\odot\geq M_2$) in
  a binary evolving through a stable mass transfer after the donor
  evolved off the main sequence (case B). We find that adopting common
  ...
  properties of \zoph. We compare the internal structure and evolution
  ...
  rotating single stars. Our model demonstrates the impact that binary
  evolution can have on the secondary star, with possible implications
  for the spins of compact objects and the further evolution (either
  in a binary or as single stars) as supernova and/or gravitational
  wave progenitors.
\end{abstract}
