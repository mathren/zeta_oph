...
\acknowledgements{We are grateful to E.~Zapartas, A.~Jermyn,
  M.~Cantiello, R.~Neuh\"auser, B.~D.~Metzger, and S.~Oey for helpful
  discussions. We also thank P.~Marchant for helpful guidance with the
  newest superadiabaticity reduction capabilities in \texttt{MESA}.}
