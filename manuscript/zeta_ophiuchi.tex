...
\begin{abstract}
  \todo{maybe move accretors in general upfront}
...
donor star \citep[e.g., recently,][]{yoon:17, gotberg:17, gotberg:18, laplace:20,
...
stellar spectra using the rotating models from \cite{meynet:00}.
...
results in a stable case B RLOF. We refer to \cite{gotberg:17, klencki:20, laplace:21, blagorodnova:21}
