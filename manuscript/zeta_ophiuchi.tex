...
($t\gtrsim7.25$\,Myr) and leads to critical surface rotation
...
mass transfer phase. The treatment of close-to-critical rotation
...
We emphasize that our models assume a Spruit-Tayler dynamo
\citep{spruit:02} for the transport of angular momentum. Recently,
\cite{fuller:19} proposed a stronger angular momentum transport which
would presumably result in a faster spin down of the surface (possibly
allowing for more accretion during mass transfer) and even more
significant core spin-up in our accretor.
