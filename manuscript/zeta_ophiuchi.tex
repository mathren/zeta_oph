...
%We assume a wind scaling factor of 1 \cite{smith:14}. 
...
% YG: this expansion is not brief compared to the rest of the mass transfer
...
panel). 
% YG: discouraging statement, I am also not sure it is correct. 
%Therefore, observation of a (population of)
