...
period choice ($P=100$\,days), this effectively means both the stars
in our binary are initially slow rotators. Our models include a
...
\cite{gotberg:17, gotberg:18, laplace:20, laplace:21}.  We assume a
...
$\omega/\omega_\mathrm{crit}\simeq 1$ reached by our
