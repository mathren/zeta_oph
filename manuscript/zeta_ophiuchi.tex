...
\begin{abstract}
  ...
  ($M_1\gtrsim 20\,M_\odot\geq M_2$) in a binary evolving through a
  stable mass transfer after the donor evolved off the main sequence
  (case B). We find that adopting common assumptions for the treatment
  of rotation, chemical mixing, and mass transfer efficiency, our
  models of the accreting star reproduce reasonably well the
  kinematic, spectroscopic, and photometric properties of \zoph. We
  compare the internal structure and evolution of our accretor to
  fast-rotating single stars, and find that the late and extreme spin
  up by binary interactions yields at the end of the main sequence a
  faster-spinning core in the accretor than in rotating single stars. Our model
  demonstrates the impact that binary evolution can have on the
  secondary star, with possible implications for the spins of compact
  objects and the further evolution (either in a binary or as single
  stars) as supernova and/or gravitational wave progenitors.
\end{abstract}
...
studies \citep[e.g.,][]{yoon:17, gotberg:17, gotberg:18, laplace:20,
...
companion \citep[``binary SN scenario'', ][]{blaauw:61, dedonder:97,
  eldridge:11, boubert:18, renzo:19walk, evans:20}. Therefore, populations of
...
stand out in astrometric surveys. Assuming a constant star formation history,
\cite{renzo:19walk} estimated that $10.1^{+4.6}_{-8.6}\%$ of O-type
stars could be accretors released after a SN. %  -- where the errors span
...
Finally, the majorityof isolated binary evolutionary scenarios for
...
$M_1=25\,M_\odot$, $M_2=17\,M_\odot$ and initial period of $100$\,days
assuming a metallicity of $Z=0.01$.
...
results in a stable case B RLOF. We refer to \cite{dewi:00, gotberg:17, laplace:21, blagorodnova:21}
