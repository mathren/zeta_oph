...
($\dot M_\mathrm{wind}<0$), and the dashed blue line shows the sum of
these two terms with opposite signs, again corresponding to the total
rate of mass change.  At peak (point C), the mass transfer rates
