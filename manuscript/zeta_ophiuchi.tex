...
dynamo for the transport of angular momentum, and chose the same free
parameters as \cite{heger:00}. This also includes the rotational
enhancement of wind mass loss as in \cite{langer:98}.\todo{check this
  statement
}
