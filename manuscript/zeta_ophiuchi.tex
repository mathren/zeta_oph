...
10^4$\,K, mass transfer starts. This results in a stable case B RLOF. We refer to \cite{gotberg:17, klencki:20, laplace:21, blagorodnova:21} and references therein for a detailed description of the evolution of massive donor stars in binaries. Although our models are more massive, the qualitative behavior of the donor star is similar. Differences in the details of the behavior might arise because of the complex behavior of the intermediate convective zone above the H-burning shell \citep[][]{klencki:21}.
