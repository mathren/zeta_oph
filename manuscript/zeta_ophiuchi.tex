...
\begin{figure}[htbp]
  ...
  \caption{Hertzsprung-Russell diagram for the progenitor binary of
    \zoph. The top panel shows the accretor, the bottom panel show the
    donor, with the color indicating the surface $^4\mathrm{He}$ mass
    fraction. The red datapoint shows the position of \zoph\ according
    to \cite{villamariz:05}. Note the different scale on the two
    panels.}
  \label{fig:HRD_both}
\end{figure}
