...
surface composition and rotational velocity (cf.~\Tabref{tab:surf_prop})are in the right ballpark.
...
\acknowledgements{We are grateful to E.~Zapartas, A.~Jermyn,
  M.~Cantiello, R.~Neuh\"auser, and B.~D.~Metzger for helpful discussions.}
