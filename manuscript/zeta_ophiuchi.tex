...
$\sim$$1\,M_\odot$ wide above the core, but disconnected from it. This is a consequence of core growth because of accretion, and can affect the density profile at the base of the envelope (see
...
\begin{figure*}[htbp]
  ...
  \caption{$^{14}\mathrm{N}$ mass fraction as a function of mass
    ...
    RLOF, and the black dotted profile corresponds to the black
...
\begin{figure*}[tbp]
  ...
  \caption{Top: Internal rotational profile for $20\,M_\odot$ single
    ...
    the top panel the thin dashed red line mark the TAMS surface
    rotation rate. In the rightmost panels, the gray areas indicate
...
late RLOF phase (beyond point B in
...
``kink'' feature in \Figref{fig:HRD_both}, and refer the readers
