...
% Discouraging, I don't see that this sentence is necessary.
...
% YG: for the MS - how weak is that rotational mixing in the envelope? Could that ever do anything?
...
\begin{figure*}[tbp]
  ...
  \caption{$^{14}\mathrm{N}$ mass fraction as a function of mass
    ...
    $^{14}\mathrm{N}$ mass fraction of \zoph\ estimated by \citetalias{villamariz:05} assuming
...
% Why we go just to nitrogen enrichment when there are changes to the other element compositions too
...
% Here, it would be nice to say later at what time the first changes in the N-profile start to occur for the rotating stars.
...
% I think one more sentence explaining where the N comes from would be great. 
...
the single stars. % -- and rejuvenation. % How do you mean rejuvenation is mixing CNO processed material outwards? 
...
occurs. % YG: We don't have a profile of this early stage in Fig. 7, right? 
Late during RLOF, close to point F in %shortly after point C in
...
% The above sentence can be confusing, because even though the core grows, the convective mixing is just in the core and the N-rich material doesn't get mixed more out than that... 
