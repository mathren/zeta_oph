...
mixing from the surface. We were



\todo{no Eddington
  sweet, effect on R and thus $\omega/\omega_{crit}$ and mass transfer
efficiency}.

\todo{higher thermohaline mixing}


 We attempted running models
...
nitrogen and helium rich surface composition without assuming that the
surface excess of He and N comes entirely from within the
star. Instead, this material is transferred from the receeding core of
the donor star and mixed inwards but rotation, and to a smaller
degree, thermohaline mixing.

Thus, the present day surface mass fraction of \zoph\ put a coupled
constrain the mass transfer efficiency and mixing in the
accretor. Standard stellar physics assumptions common in the numerical
modeling of these processes reproduce reasonably well the main
observational features of \zoph. Therefore, such star should
\emph{not} be used to calibrate models of rotational mixing in single
star evolution, nor its more extreme version of chemically homogeneous
evolution.
