...
To illustrate the dominant processes processes throughout the
...
of \Figref{fig:HRD_both}. The last panel represents the predicted
...
\begin{figure*}[htbp]
  ...
  \caption{Mixing diffusion coefficients in the accretor star. From
    ...
    non-rotational mixing processes (i.e., here overshooting, thin blue line), convection
    (shown in red), thermohaline mixing (pink) and semiconvection (in
    purple). The HRD position for each panel is marked by a thin blue
    cross in \Figref{fig:HRD_both}}
  \label{fig:D_mix}
\end{figure*}
