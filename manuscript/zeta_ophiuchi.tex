...
\referee{In contrast to single rotating stars, the chemical enrichment
  in our accretor model comes primarily from accretion of
  CNO-processed material from the inner layers of the donor star. Only
  a smaller fraction of the enrichment is caused by outward mixing
  from its own core.}
...
\Tabref{tab:surf_prop}). \referee{In the remaining main sequence
  lifetime, rotational mixing brings in the envelope some more
  CNO-enriched material from the accretor's own core.} % \referee{This corresponds to a surface ratio
