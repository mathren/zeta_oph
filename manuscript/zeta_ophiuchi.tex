...
the ``steps'' in these curves are numerical artifacts which do not
impact our conclusions here. The bottom panel of \Figref{fig:surf_rot}
shows instead the ratio of the surface rotational frequency
...
$^{16}\mathrm{O}$. We also show a movie of the time evolution of
