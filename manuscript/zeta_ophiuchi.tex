...
panel). Therefore, it is unlikely to probe directly the accuracy of
our treatment of mixing by observing the RLOF phase or a population of
mass-transferring binaries. We expand on
...
0.2$ and the layer still containing H will possibly be removed by further wind mass loss \citep[e.g.,][]{yoon:17, gotberg:17}.
