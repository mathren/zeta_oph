...
Our fiducial model (see \Secref{sec:best_model}) is a binary starting with
$M_1=25\,M_\odot$, $M_2=17\,M_\odot$, and $P=100$\,days at metallicity
$Z=0.01$ (see \Secref{sec:best_model}). It experiences stable thermal-timescale Roche lobe
...
% % reproduce reasonably well the main features of \zoph.
...
% Our model of \zoph\ differs significantly from previous studies, and
% highlights some general differences between accretors in massive
% binaries and stars evolving as single throughout their life.
% In contrast with \cite{vanrensbergen:96}, in our model the
% $^{14}\mathrm{N}$- and $^4\mathrm{He}$-rich surface composition is not
% the result of pure outward rotational mixing.  Instead, this material
...
% \todo{
%   \begin{itemize}
%   % \item \zoph is well reproduced
%   \item difference with single stars (core rotation, convective layer
%     above the core)
%   \item lessons for accretors in general and way forward
%   \end{itemize}
% }
...
%  This binary system experiences
% stable thermal-timescale Roche
