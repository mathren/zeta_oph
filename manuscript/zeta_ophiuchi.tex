...
N-enhancement.%  \referee{However, the composition of the accreted
  % material and the material being mixed out from the core of the
  % accretor star can be different.}
...
\referee{During RLOF, both $^4\mathrm{He}$ and $^{14}\mathrm{N}$
  surface mass fractions increase significantly because of the
  accretion of material from the donor's core. They reach maximum
  values of $\sim{}0.65$ and $6\times10^{-3}$,
  respectively. Subsequently, these elements are partially mixed inwards
  and partially ejected by the accretor's wind.}  After RLOF, the
surface $^4\mathrm{He}$ mass fraction of the accretor has increased by
$\sim{}20\,\%$, from \referee{its primordial value of} 0.26 up to
0.31, while the surface $^{14}\mathrm{N}$ mass fraction has increased
by a factor of 2.5, from $5\times 10^{-4}$ up to
$1.346 \times 10^{-3}$ (see also
