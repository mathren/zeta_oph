...
We adopt the \cite{ledoux:47} criterion to determine convective stability and a
...
sequence from \cite{brott:11}. We do not use over/undershooting for
...
\begin{figure*}[htbp]
  \includegraphics[width=\textwidth]{D_mix_vertical}
