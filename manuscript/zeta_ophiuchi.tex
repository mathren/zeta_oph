...
\Figref{fig:surf_rot} shows the evolution of the equatorial rotational
velocity $v_\mathrm{rot}$ for our accretor model, not including any
projection effect. More precisely,
$v_\mathrm{rot}$ is a mass-weighted average of the rotation rate of
the stellar layers with opacity $\tau\leq 100$. The dark horizontal red band
corresponds to the $v\sin(i)=432\pm16\,\kms$ measured by \cite{zehe:18}, and the lighter
