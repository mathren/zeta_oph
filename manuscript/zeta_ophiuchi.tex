...
\subsection{Mixing and composition: comparison of accretors and single
  fast-rotating stars}
\label{sec:mixing}
...
rotation rates), hence their TAMS profile does not have an as light
...
of the CNO burning cycle, and it is then mixed outwards in time
producing a monotonically decreasing $^{14}\mathrm{N}$ profile. The
higher the initial rotation, the higher the surface $^{14}\mathrm{N}$
mass fraction reached at TAMS.

Conversely, the $^{14}\mathrm{N}$ mass fraction profile of the
accretor is \emph{not} monotonic and it is shaped not only by outward
...
thermohaline mixing. Initially, the tidally synced secondary star
rotates too slowly for significant outward rotational mixing out of
the core, and until the onset of RLOF no appreciable variation of the
...
\citep[e.g.][]{schneider:16}, driving some outward convective mixing
of N-rich material. Because convection turnover timescales are much
shorter than evolutionary timescales.
...
\todo{describe typical evolution of rotating model and compare to accretor}
The typical evolution


\subsection{Angular momentum transport and surface rotation: comparison of accretors and single
  fast-rotating stars}
\label{sec:rot}
