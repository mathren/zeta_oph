...
\begin{abstract}
  ...
  17\Msun\ star, which experiences stable mass transfer. We focus on the
  ...
  show that our model of the accretor star broadly reproduces the properties of
  $\zeta$ Ophiuchi, which has long been proposed to have accreted mass
  before being ejected as a runaway star when the companion exploded.  We
  compare our accretor star model to models of single rotating stars and find that the
  later and stronger spin-up provided by mass accretion produces
  significant differences. Specifically, the core of the accretor
  retains higher spin at the end of the main sequence, and a convective layer develops that changes its density profile. Moreover, the surface of the accretor star is polluted by CNO-processed material donated by the companion star. Our models show effects of mass accretion in binaries that are not captured in single rotating stellar
...
Parametrized models of rotational mixing
...
mixing can efficiently bring CNO-processed material to the
