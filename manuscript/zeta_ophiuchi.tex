...
Wolf-Rayet star. \todo{Ylva: want to expand?}.
...
From the black diamond onwards, we evolve the accretor as a single star with the same \texttt{MESA} setup until TAMS. The red point with errors in the bottom panel of \Figref{fig:HRD_both} marks the approximate position of \zoph based on the analysis of \cite{villamariz:05}. The color of the track in \Figref{fig:HRD_both} indicate that our accreting star spends about
...
$7.262$\,Myrs. We find this to be the culprit of difficulties in
...
mass fraction of $\sim$0.8, and quickly contracts.
