...
% With a name of a star in the title, I worry that it will be easy to glance over this paper, it may look more like a model of yet another star type of paper - this is more unique than that
%\title{Accretor stars in massive binaries: testing models on  $\zeta$ Ophiuchi}
\title{Evolutionary models of accretor stars in massive binaries: the
  case of $\zeta$ Ophiuchi} % it needs to be even more snazzy
...
\citep{wheeler:75, tauris:98, podsiadlowski:03, hirai:18, ogata:21}.
...
343\,R_\odot$ in our fiducial binary model), \cite{hirai:18} and \cite{ogata:21} found that the companion star recovers its pre-explosion luminosity and effective temperature within a few years to decades, and the amount of mass removed by the SN shock is
