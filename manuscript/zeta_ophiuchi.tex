...
\begin{figure}[htbp]
  ...
  \caption{Surface averaged rotation rate for the accretor model. At
...
main sequence, the increase in wind mass loss rate and internal
transport of angular momentum causes a change in the spin-down
slope. This effect is also seen in the late main-sequence evolution of
single stars rotating rapidly from ZAMS.
...
reported by \cite{marcolino:09} (weak wind problem), however, see also
\citealt{lucy:12, lagae:21}. While this may impact the evolution of the
...
models. Typically, single stars are assumed to be rigid rotators at
ZAMS \citep[e.g.,][]{ekstrom:12}. The internal rotational profile of a
single star rigidly rotating at birth is different than the profile
