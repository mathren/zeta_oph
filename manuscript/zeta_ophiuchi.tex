...
\begin{abstract}
  ...
  O-type star to Earth, $\zeta$ Ophiuchi (\zoph), has long been
  proposed to be a product of binary evolution. Specifically, \zoph\
  has likely accreted mass from a former companion, before being
  ejected at the time of the companion's supernova
  explosion. Therefore, this star provides an ideal test bed for
  models of accretors in binaries. Despite this, most stellar models
  ...
  coupled evolution of two massive stars
  ($M_1\gtrsim 25\,M_\odot\geq M_2$) in a binary evolving through a
  stable post-donor-main-sequence (case B) mass transfer. We find that
  adopting common assumptions for the treatment of rotation, chemical
  mixing, and mass transfer efficiency, our models of the accreting
  star reproduce reasonably well the kinematic, spectroscopic, and
  ...
  find that the late and extreme spin up by binary interactions yields
  at the end of the main sequence a faster-spinning core in the
  accretor than in single stars. Our model demonstrates the impact
  that binary evolution can have on the secondary star, with possible
  implications for the spins of compact objects and the further
  evolution (either in a binary or as single stars) as supernova
  and/or gravitational wave progenitors.
\end{abstract}
...
studies \citep[e.g.,][]{gotberg:17, gotberg:18, laplace:20,
  laplace:21, blagorodnova:21} \todo{more refs. from other groups}
have focused on the dramatic impact these interactions have on the
donor star. Often the binary companion is treated as a point mass.
