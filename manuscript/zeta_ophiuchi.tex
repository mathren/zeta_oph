...
the rotational enhancement of wind mass loss as in \cite{langer:98}.
...
the approximate position of \zoph\ based on the spectral analysis of \citetalias{villamariz:05}. The color of the track in \Figref{fig:HRD_both} indicate that our accreting star spends about
