...
with masses $\gtrsim 20\,M_\odot$ with the \texttt{MESA} stellar
...
$Z=0.001$. This binary system experiences a dynamically stable Roche
lobe overflow after the end of the most massive star main sequence
...
remaining donor's lifetime at the end of our simulations plus the kinematic age,
...
\item Fast surface rotation (albeit possibly on the low side);
