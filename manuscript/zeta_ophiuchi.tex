...
Since neither the initial donor mass
$M_1$ nor the initial period can be directly constrained, it is
possible that different values would result in easier-to-explode
donors with a similar accretor on a and faster (or slower) orbit.
