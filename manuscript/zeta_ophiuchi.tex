...
\referee{However, these two mechanism tap into the core at different
  ...
  $^{14}\mathrm{N}$ is fixed to the CNO-equilibrium
  abundance. Conversely, the material coming from the donor during a
  case B RLOF has a composition fixed in time by the donor's main
  sequence evolution. However, we emphasize that the ratio of
...
\Tabref{tab:surf_prop}). \referee{This corresponds to a surface ratio
  ...
  typical error bars on abundances.}
...
accretor's internal composition profile for \referee{four} elements
